...
export default function DashboardLayout({ children }) {
  ...
  const { contract, getTokenPrice, getRole } = useVault();
            ...
            <div className="market-header flex items-center justify-between">
              ...
              <div className="admin_active" id="header_admin">
                ...
                <div className="relative">
                  <div className="user">
                    <div className="flex" onClick={() => open()}>
          ...
          <div className="flat-tabs">
            <div className={`section-menu-left ${isMobileSidebar ? 'null' : ''}`}>
              ...
              <div className="over-content">
                <div className="content">
                  ...
                  <ul className="menu-tab">
                    <li
                      className={router.pathname === '/dashboard' ? 'tablinks active' : 'tablinks'}
                      onClick={() => {
                    ...
                    <li
                      className={router.pathname === '/invest' ? 'tablinks active' : 'tablinks'}
                      onClick={() => {
                        router.push('/invest');
                      }}
                    >
                    ...
                    <li
                      className={router.pathname === '/rewards' ? 'tablinks active' : 'tablinks'}
                      onClick={() => {
                        router.push('/rewards');
                      }}
                    >
                ...
                {(role === 'owner' || role === 'ceo' || role === 'operator') && (
                  <div className="content mt-30">
                    ...
                    <ul className="menu-tab">
                      ...
                      {(role === 'owner' || role === 'ceo') && (
                        <li
                          className={router.pathname === '/manage-users' ? 'tablinks active' : 'tablinks'}
                          onClick={() => {
                      ...
                      {(role === 'owner' || role === 'ceo') && (
                        <li
                          className={router.pathname === '/withdraw' ? 'tablinks active' : 'tablinks'}
                          onClick={() => {
                      ...
                      <li
                        className={router.pathname === '/profitshare' ? 'tablinks active' : 'tablinks'}
                        onClick={() => {
                          router.push('/profitshare');
                        }}
                      >
                        <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g opacity="0.2">
                      ...
                      {(role === 'owner' || role === 'ceo') && (
                        <li
                          className={router.pathname === '/settings' ? 'tablinks active' : 'tablinks'}
                          onClick={() => {
              ...
              <div className="bottom">
                <p>© 2024</p>
                <p>Santistef International</p>
              </div>
            </div>
            <div className="content-tabs">
              <div className="tabcontent active">{children}</div>
            </div>
          </div>
        </div>
      </div>
