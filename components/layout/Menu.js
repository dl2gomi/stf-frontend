      ...
      <ul id="menu-primary-menu" className="menu">
        {/* <li className="menu-item menu-item-has-children">
          ...
          <ul className="sub-menu">
            ...
            <li className={router.pathname == '/home-2' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/home-2">Home 2</Link>
            </li>
            <li className={router.pathname == '/home-3' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/home-3">Home 3</Link>
            </li>
            <li className={router.pathname == '/home-4' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/home-4">Home 4</Link>
            </li>
            <li className={router.pathname == '/home-5' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/home-5">Home 5</Link>
            </li>
            <li className={router.pathname == '/home-6' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/home-6">Home 6</Link>
            </li>
            <li className={router.pathname == '/home-7' ? 'menu-item current-item' : 'menu-item'}>
        ...
        {/* <li className="menu-item menu-item-has-children">
          <a>Explore</a>
          <ul className="sub-menu">
            <li className={router.pathname == '/explore-1' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/explore-1">Explore Style 1</Link>
            </li>
            <li className={router.pathname == '/explore-2' ? 'menu-item current-item' : 'menu-item'}>
            ...
            <li className={router.pathname == '/explore-4' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/explore-4">Explore Style 4</Link>
            </li>
            <li className={router.pathname == '/product-detail-1' ? 'menu-item current-item' : 'menu-item'}>
            ...
            <li className={router.pathname == '/product-detail-3' ? 'menu-item current-item' : 'menu-item'}>
        ...
        {/* <li className="menu-item menu-item-has-children">
          ...
          <ul className="sub-menu">
            ...
            <li className={router.pathname == '/author-1' ? 'menu-item current-item' : 'menu-item'}>
        ...
        {/* <li className="menu-item menu-item-has-children">
          <a>Blog</a>
          <ul className="sub-menu">
            <li className={router.pathname == '/blog-grid' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/blog-grid">Blog Grid</Link>
            </li>
            <li className={router.pathname == '/blog-grid-1' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/blog-grid-1">Blog Grid 1</Link>
            </li>
            <li className={router.pathname == '/blog-list' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/blog-list">Blog List</Link>
            </li>
            <li className={router.pathname == '/blog-list-1' ? 'menu-item current-item' : 'menu-item'}>
              <Link href="/blog-list-1">Blog List 1</Link>
            </li>
            <li className={router.pathname == '/blog-detail' ? 'menu-item current-item' : 'menu-item'}>
