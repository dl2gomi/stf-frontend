          ...
          <div className="row">
            <div className="col-md-12">
              <div className="heading-section justify-content-center">
                <h2 className="tf-title pb-30">Step by step Invest and Claim your Rewards</h2>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
              <div className="tf-box-icon relative text-center">
                ...
                <h4 className="heading">
                  <Link href="/invest">Invest your funds</Link>
                </h4>
                <p className="content">Invest your funds using crypto wallets to this platform to get the STF tokens</p>
                <div className="arrow">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="tf-box-icon relative text-center">
                ...
                <h4 className="heading">
                  <Link href="/rewards">Claim the rewards</Link>
                </h4>
                <p className="content">
                  Claim the reward from this platform. Need to claim all rewards before any investment.
                </p>
              </div>
            </div>
          </div>
